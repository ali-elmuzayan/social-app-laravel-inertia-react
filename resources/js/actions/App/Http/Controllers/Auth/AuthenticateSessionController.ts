...
/**
* @see \App\Http\Controllers\Auth\AuthenticateSessionController::destroy
* @see app/Http/Controllers/Auth/AuthenticateSessionController.php:30
* @route '/logout'
*/
...
const AuthenticateSessionController = { create, store, destroy }

export default AuthenticateSessionController